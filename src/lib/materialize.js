...
(function (factory) {
  ...
  function find(selector, context) {
    context = context || doc;
    const elems = classMatch.test(selector)
  ...
  const fn = (cash.fn = cash.prototype = Init.prototype = {
    // jshint ignore:line
    cash: true,
    length: 0,
    push,
  ...
  function unique(collection) {
    return cash(
      slice.call(collection).filter((item, index, self) => self.indexOf(item) === index),
    );
  }
  ...
  fn.extend({
    ...
    filter(selector) {
      ...
      const comparator = isFunction(selector)
        ? selector
        : getCompareFunction(selector);

      return cash(
        filter.call(this, (e) => comparator(e, selector)),
      );
    },
  ...
  const camelCase = (function () {
    ...
    const whiteSpace = /[\s-_]+/g;
    return function (str) {
      return str
        .replace(camelRegex, (letter, index) => letter[index === 0 ? 'toLowerCase' : 'toUpperCase']())
        .replace(whiteSpace, '');
    };
  }());
  ...
  fn.extend({
    children(selector) {
      ...
      return !selector
        ? elems
        : elems.filter((v) => matches(v, selector));
    },
...
M.tabPressed = false;
M.keyDown = false;
const docHandleKeydown = function (e) {
  M.keyDown = true;
  if (
    e.which === M.keys.TAB
...
const docHandleKeyup = function (e) {
  M.keyDown = false;
  if (
    e.which === M.keys.TAB
    || e.which === M.keys.ARROW_DOWN
...
const docHandleFocus = function (e) {
  if (M.keyDown) {
    document.body.classList.add('keyboard-focused');
  }
};
const docHandleBlur = function (e) {
  ...
  jQuery.fn[pluginName] = function (methodOrOptions) {
    ...
    if (plugin.prototype[methodOrOptions]) {
      ...
      if (methodOrOptions.slice(0, 3) === 'get') {
        const instance = this.first()[0][classRef];
        return instance[methodOrOptions].apply(instance, params);
      }

      // Void methods
      return this.each(function () {
        const instance = this[classRef];
...
M.throttle = function (func, wait, options) {
  ...
  */
const $jscomp = { scope: {} };
$jscomp.defineProperty = typeof Object.defineProperties === 'function'
...
$jscomp.initSymbolIterator = function () {
  $jscomp.initSymbol();
  let e = $jscomp.global.Symbol.iterator;
...
$jscomp.arrayIterator = function (e) {
  let r = 0;
  return $jscomp.iteratorPrototype(() => (r < e.length ? { done: !1, value: e[r++] } : { done: !0 }));
};
...
$jscomp.polyfill(
  ...
  (e) => (e || function () {
    return $jscomp.iteratorFromArray(this, (e) => e);
  }),
  'es6-impl',
  'es3',
);
...
(function (r) {
  ...
  function p(a) {
    return a.reduce((a, d) => a.concat(h.arr(d) ? p(d) : d), []);
  }
  function m(a) {
    if (h.arr(a)) return a;
    h.str(a) && (a = e(a) || a);
  ...
  function T(a) {
    a = a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, (a, c, d, k) => c + c + d + d + k + k);
    var c = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a);
    a = parseInt(c[1], 16);
    const d = parseInt(c[2], 16);
    var c = parseInt(c[3], 16);
    return `rgba(${a},${d},${c},1)`;
  }
  function U(a) {
    function c(a, c, b) {
    ...
    var f = parseInt(d[3]) / 100;
    var d = d[4] || 1;
    if (b == 0) f = b = a = f;
    else {
      const n = f < 0.5 ? f * (1 + b) : f + b - f * b;
      const k = 2 * f - n;
      var f = c(k, n, a + 1 / 3);
      var b = c(k, n, a);
      a = c(k, n, a - 1 / 3);
  ...
  function P(a) {
    ...
    return r(a, (a, d, b) => b.indexOf(a) === d);
  }
  function Z(a) {
    const c = P(a);
    return c.map((a, b) => ({ target: a, id: b, total: c.length }));
  }
  function aa(a, c) {
    const d = C(c);
    if (h.arr(a)) {
  ...
  function da(a, c) {
    let d;
    return a.tweens.map((b) => {
      b = ba(b, c);
      const f = b.value;
      var e = K(c.target, a.name);
      var k = d ? d.to.original : e;
      var k = h.arr(f) ? f[0] : k;
      const w = L(h.arr(f) ? f[1] : f, k);
      var e = y(w) || y(k) || y(e);
      b.from = O(k, e);
      b.to = O(w, e);
  ...
  function q(a) {
    ...
    function b(a) {
      for (var b = 0, c = {}, d = g.animations, f = d.length; b < f;) {
        ...
        n
          && (l = r(h, (b) => a < b.end)[0] || l);
        for (
          var h = Math.min(Math.max(a - l.start - l.delay, 0), l.duration)
              / l.duration,
          ...
          var x = void 0;
          var x = l.to.numbers[t];
          const q = l.from.numbers[t];
          var x = l.isPath ? Y(l.value, w * x) : q + w * (x - q);
    ...
    function k(a) {
      ...
      if (q > n && q < k) b(q);
        ...
        (q <= n && r !== 0 && (b(0), x && e()), (q >= k && r !== k) || !k)
      ) b(k), x || e();
      f('update');
      a >= k
        && (g.remaining
          ? ((t = h), g.direction === 'alternate' && (g.reversed = !g.reversed))
          : (g.pause(),
          g.completed
              || ((g.completed = !0),
              f('complete'),
  ...
  var W = 'translateX translateY translateZ rotate rotateX rotateY rotateZ scale scaleX scaleY scaleZ skewX skewY perspective'.split(
    ' ',
  );
  let H;
  var h = {
    ...
    return function (c, d, b, f) {
      if (c >= 0 && c <= 1 && b >= 0 && b <= 1) {
        ...
        return function (k) {
          ...
          if (k === 0) return 0;
          if (k === 1) return 1;
          for (var h = 0, l = 1; l !== 10 && e[l] <= k; ++l) {
            h += 0.1;
          }
          --l;
          var l = h + ((k - e[l]) / (e[l + 1] - e[l])) * 0.1;
          let n = 3 * (1 - 3 * b + 3 * c) * l * l
                + 2 * (3 * b - 6 * c) * l
                + 3 * c;
          if (n >= 0.001) {
            for (h = 0; h < 4; ++h) {
  ...
  var Q = (function () {
    ...
    const b = { linear: A(0.25, 0.25, 0.75, 0.75) };
    let f = {};
    let e;
    for (e in d) {
      (f.type = e),
...
(function ($, anim) {
  ...
  const Dropdown = (function (_Component2) {
    ...
    function Dropdown(el, options) {
      ...
      const _this9 = _possibleConstructorReturn(
        this,
        ...
        },
        {
          ...
          value: function _handleDropdownClick(e) {
            ...
            if (typeof this.options.onItemClick === 'function') {
              const itemEl = $(e.target).closest('li')[0];
        ...
        },
        {
          ...
          value: function _handleDropdownKeydown(e) {
            ...
            if (letter && nonLetters.indexOf(e.which) === -1) {
              ...
              const newOptionEl = $(this.dropdownEl)
                .find('li')
                .filter((el) => (
                  $(el)
                    .text()
...
(function ($, anim) {
  ...
  const Modal = (function (_Component3) {
    ...
    function Modal(el, options) {
      ...
      const _this13 = _possibleConstructorReturn(
        this,
...
(function ($) {
  ...
  const Parallax = (function (_Component5) {
    ...
    function Parallax(el, options) {
      ...
      const _this21 = _possibleConstructorReturn(
        this,
      ...
      [
        ...
        },
        {
          ...
          value: function _handleWindowResize() {
            for (let i = 0; i < Parallax._parallaxes.length; i++) {
              const parallaxInstance = Parallax._parallaxes[i];
              parallaxInstance._enabled = window.innerWidth
...
(function ($, anim) {
  ...
  const Tabs = (function (_Component6) {
    ...
    function Tabs(el, options) {
      ...
      const _this22 = _possibleConstructorReturn(
        this,
      ...
      [
        ...
        },
        {
          ...
          value: function _setTabsAndTabWidth() {
            ...
            this.tabWidth = Math.max(this.tabsWidth, this.el.scrollWidth)
...
(function ($, anim) {
  ...
  const Tooltip = (function (_Component7) {
    ...
    function Tooltip(el, options) {
      ...
      const _this26 = _possibleConstructorReturn(
        this,
      ...
      [
        ...
        },
        {
          ...
          value: function _positionTooltip() {
            ...
            let newCoordinates = void 0;
            const { margin } = this.options;
            let targetTop = void 0;
            let targetLeft = void 0;
...
(function (window) {
  ...
  var Effect = {
    ...
    show(e, element) {
      ...
      ripple.className += ' waves-notransition';
    ...
    hide(e) {
      ...
      const el = this;
      const width = el.clientWidth * 1.4;
...
(function ($, anim) {
  ...
  const Sidenav = (function (_Component8) {
    ...
    function Sidenav(el, options) {
      ...
      const _this31 = _possibleConstructorReturn(
        this,
...
(function ($, anim) {
  ...
  const ScrollSpy = (function (_Component9) {
    ...
    function ScrollSpy(el, options) {
      ...
      const _this35 = _possibleConstructorReturn(
        this,
      ...
      [
        ...
        },
        {
          ...
          value: function _handleWindowScroll() {
            ...
            const intersections = ScrollSpy._findElements(
              top,
              right,
              bottom,
              left,
        ...
        },
        {
          ...
          value: function _exit() {
            ...
            if (ScrollSpy._visibleElements[0]) {
              ...
              ScrollSpy._visibleElements = ScrollSpy._visibleElements.filter(
                (el) => el.attr('id') != _this36.$el.attr('id'),
              );
              if (ScrollSpy._visibleElements[0]) {
                // Check if empty
                $(
...
(function ($) {
  ...
  const Autocomplete = (function (_Component10) {
    ...
    function Autocomplete(el, options) {
      ...
      const _this37 = _possibleConstructorReturn(
        this,
...
(function ($, anim) {
  ...
  const Slider = (function (_Component11) {
    ...
    function Slider(el, options) {
      ...
      const _this40 = _possibleConstructorReturn(
        this,
      ...
      _this40.$slides.find('.caption').each((el) => {
        _this40._animateCaptionIn(el, 0);
      });

      // Move img src into background-image
      _this40.$slides.find('img').each((el) => {
      ...
      _this40.$active.find('img').each((el) => {
        anim({
          ...
          value: function set(index) {
            ...
            if (this.activeIndex != index) {
              ...
              anim({
                ...
                easing: 'easeOutQuad',
                complete() {
                  _this44.$slides.not('.active').each((el) => {
                    anim({
                      targets: el,
                      opacity: 0,
                      translateX: 0,
...
(function ($) {
  ...
  const Chips = (function (_Component12) {
    ...
    function Chips(el, options) {
      ...
      const _this45 = _possibleConstructorReturn(
        this,
...
(function ($) {
  ...
  const Pushpin = (function (_Component13) {
    ...
    function Pushpin(el, options) {
      ...
      const _this47 = _possibleConstructorReturn(
        this,
...
(function ($, anim) {
  ...
  const FloatingActionButton = (function (_Component14) {
    ...
    function FloatingActionButton(el, options) {
      ...
      const _this48 = _possibleConstructorReturn(
        this,
        (
...
(function ($) {
  ...
  const Datepicker = (function (_Component15) {
    ...
    function Datepicker(el, options) {
      ...
      const _this53 = _possibleConstructorReturn(
        this,
      ...
      const defDate = _this53.options.defaultDate;
      ...
      [
        ...
        },
        {
          ...
          value: function destroySelects() {
            const oldYearSelect = this.calendarEl.querySelector(
              '.orig-select-year',
            );
            if (oldYearSelect) {
              M.FormSelect.getInstance(oldYearSelect).destroy();
            }
            const oldMonthSelect = this.calendarEl.querySelector(
              '.orig-select-month',
            );
            if (oldMonthSelect) {
        ...
        },
        {
          ...
          value: function _renderDateDisplay() {
            const displayDate = Datepicker._isDate(this.date)
              ? this.date
              : new Date();
        ...
        },
        {
          ...
          value: function render(year, month, randId) {
            ...
            const daysInPreviousMonth = Datepicker._getDaysInMonth(
              yearOfPreviousMonth,
              previousMonth,
            );
        ...
        },
        {
          ...
          value: function renderTitle(
            ...
            yearHtml = `<select class="datepicker-select orig-select-year" tabindex="-1">${
              arr.join('')
            }</select>`;
        ...
        },
        {
          ...
          value: function draw(force) {
            ...
            const monthSelect = this.calendarEl.querySelector(
              '.orig-select-month',
            );
        ...
        },
        {
          ...
          value: function _setupVariables() {
            ...
            this.formats = {
              ...
              mm() {
                const m = _this56.date.getMonth() + 1;
                return (m < 10 ? '0' : '') + m;
              },
              mmm() {
...
(function ($) {
  ...
  const Timepicker = (function (_Component16) {
    ...
    function Timepicker(el, options) {
      ...
      const _this57 = _possibleConstructorReturn(
        this,
      ...
      [
        ...
        },
        {
          ...
          value: function _pickerSetup() {
            ...
            const confirmationBtnsContainer = $(
        ...
        },
        {
          ...
          value: function resetClock(delay) {
            ...
            const radius = isHours && value > 0 && value < 13
              ? this.options.innerRadius
              : this.options.outerRadius;
        ...
        },
        {
          ...
          value: function setHand(x, y, roundBy5) {
            ...
            const cy1 = -Math.cos(radian) * (radius - this.options.tickRadius);
...
(function ($) {
  ...
  const CharacterCounter = (function (_Component17) {
    ...
    function CharacterCounter(el, options) {
      ...
      const _this61 = _possibleConstructorReturn(
        this,
        (
...
(function ($) {
  ...
  const Carousel = (function (_Component18) {
    ...
    function Carousel(el, options) {
      ...
      const _this62 = _possibleConstructorReturn(
        this,
      ...
      _this62.$el.find('.carousel-item').each((el, i) => {
      ...
      [
        ...
        },
        {
          ...
          value: function _scroll(x) {
            ...
            let zTranslation = void 0;
            let tweenedOpacity = void 0;
            let centerTweenedOpacity = void 0;
            ...
            if (this.showIndicators) {
              ...
              const activeIndicator = this.$indicators.find(
            ...
            if (
              ...
              const transformString = `${alignment
              } translateX(${
                -delta / 2
              }px) translateX(${
            ...
            for (i = 1; i <= half; ++i) {
              ...
              if (!this.noWrap || this.center + i < this.count) {
                ...
                const _transformString = `${alignment
                } translateX(${
              ...
              if (!this.noWrap || this.center - i >= 0) {
                el = this.images[this._wrap(this.center - i)];
                const _transformString2 = `${alignment
                } translateX(${
                  -this.options.shift + (-this.dim * i - delta) / 2
                }px) translateZ(${
                  zTranslation
            ...
            if (
              ...
              el = this.images[this._wrap(this.center)];
              const _transformString3 = `${alignment
              } translateX(${
                -delta / 2
              }px) translateX(${
...
(function ($) {
  ...
  const TapTarget = (function (_Component19) {
    ...
    function TapTarget(el, options) {
      ...
      const _this67 = _possibleConstructorReturn(
        this,
      ...
      [
        ...
        },
        {
          ...
          value: function _calculatePositioning() {
            ...
            const isCenterX = originLeft >= windowWidth * 0.25
            ...
            // Calculating content
            const tapTargetTextWidth = isCenterX
              ? tapTargetWidth
...
(function ($) {
  ...
  const FormSelect = (function (_Component20) {
    ...
    function FormSelect(el, options) {
      ...
      const _this68 = _possibleConstructorReturn(
        this,
          ...
          value: function _handleOptionClick(e) {
            ...
            if (
              ...
              if (this.isMultiple) {
                ...
                const placeholderOption = $(this.dropdownOptions).find(
          ...
          value: function _setupDropdown() {
              ...
              this.$selectOptions.each((el) => {
                if ($(el).is('option')) {
                  ...
                  selectOptions.each((el) => {
                    const optionEl = _this71._appendOptionWithIcon(
                      _this71.$el,
                      el,
                      'optgroup-option',
                    );
            ...
            if (!this.el.disabled) {
              ...
              dropdownOptions.onOpenEnd = function (el) {
                const selectedOption = $(_this71.dropdownOptions)
                  .find('.selected')
                  .first();
...
(function ($, anim) {
  ...
  const Range = (function (_Component21) {
    ...
    function Range(el, options) {
      ...
      const _this72 = _possibleConstructorReturn(
        this,
